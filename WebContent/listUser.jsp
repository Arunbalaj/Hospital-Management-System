...
<br>
    <table id="doctor" class="foodisplay2" data-filter="#filterpe" >
        <thead>
            <tr>
                ...
                <th align="center" colspan=3>Manage Doctors</th>
            ...
            <c:forEach items="${users}" var="user">
                <tr>
                    ...
                    <td><a class='btnDelete' style='font-weight:bold' href="UserController?action=edit&userId=<c:out value="${user.userid}" />">Update</a></td>
                    <td><a class='btnDelete' style='font-weight:bold' href="UserController?action=delete&userId=<c:out value="${user.userid}"/>&email=<c:out value="${user.email}" /> ">Delete</a></td>
                    <td><a class='btnDelete' style='font-weight:bold' href="appointadminadd.jsp?name=<c:out value="${user.firstName}" />&email=<c:out value="${user.email}" />">Create Appointment</a></td>
                   </tr>
            </c:forEach>
            </tbody>
            </tbody>
    ...
    <p><a href="UserController?action=insert" style='font-size:2.2em; font-weight:bold;'>Add New Doctor</a></p>
