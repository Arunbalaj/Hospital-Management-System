...
<script type="text/javascript" src="js/jquery-ui-1.8.18.custom.min.js"></script>
 ...
 function getFieldFromFields(fieldName) 
 {
    ...
    function saveeid(){
    	 ...
    	 alert("Apponitment Created: Our Staff will Confirm your Appointment Soon. Check your Appointment Status Page for More Details.");
    	  return true;
      }
    </script>  
     <script>
...
<div class="container">
  ...
  <div class="leftcontent">
    ...
    <form method="POST" action='Appointbypat' onsubmit="return saveeid()" name="frmAddUser">
  &nbsp&nbspAppointment ID : &nbsp&nbsp<input type="text" readonly="readonly" name="userid"
     ...
     Doctor Email:
       ...
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAppointment Time : 
