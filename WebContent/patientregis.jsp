...
<script type="text/javascript" src="js/jquery-ui-1.8.18.custom.min.js"></script>
     ...
     <script>
        ...
        function saveeid(){
      	 ...
      	 alert("Profile Created: Use your Email and Password to login");
      	  return true;
        }
...
<div class="container">
  ...
  <div class="leftcontent">
    ...
    <form method="POST" action='Patientregs' onsubmit="return saveeid()" name="frmAddUser">
   &nbsp&nbsp&nbsp&nbsp&nbsp&nbspUser ID :<input type="text" readonly="readonly" name="userid"
       ...
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEmail : <input type="email" name="email"
