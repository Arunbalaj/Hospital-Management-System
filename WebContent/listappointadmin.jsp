...
<br>
        ...
        <thead>
            ...
            <c:forEach items="${users}" var="user">
                <tr>
                    ...
                    <td><a class='btnDelete' style='font-weight:bold' href="Appointmentct?action=edit&userId=<c:out value="${user.appid}" />">Update</a></td>
                    <td><a class='btnDelete' style='font-weight:bold' href="Appointmentct?action=delete&userId=<c:out value="${user.appid}"/>">Delete</a></td>
                    <td><a class='btnDelete' style='font-weight:bold' href="Appointmentct?action=confirm&userId=<c:out value="${user.appid}"/>">Confirm</a></td>
              </tr>
            </c:forEach>
            </tbody>
            </tbody>
    ...
    <p><a href="Appointmentct?action=insert" style='font-size:2.0em; font-weight:bold;'>Add New Appointment</a></p>
