...
<div class="container">
  ...
  <div class="leftcontent">
    ...
    <form method="POST" action='Appointmentct' name="frmAddUser">
   &nbsp&nbspAppointment ID : &nbsp&nbsp<input type="text" readonly="readonly" name="userid"
     ...
     Doctor Email:
       ...
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Appointment Time : 
            ...
            <select name="aptim" id="aptim" style="width:130px;" value="" >
	...
	<option value="5.00PM">5.00PM</option>
       ...
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Patient Name : <input
        ...
        <input type="email" name="pemail"  value="<c:out value="${user.pemail}"/>" /> <br><br>
