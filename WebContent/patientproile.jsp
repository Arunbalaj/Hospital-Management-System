...
<div class="container">
  ...
  <div class="leftcontent">
    ...
    <form method="POST" action='Patientprof' name="frmAddUser">
   &nbsp&nbsp&nbsp&nbsp&nbsp&nbspUser ID :<input type="text" readonly="readonly" name="userid"
       ...
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEmail : <input type="email" name="email"
       ...
       &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Sex:&nbsp
             <select name="psex" id="psex" style="width:130px;" value=""  >
