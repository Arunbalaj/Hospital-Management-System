            ...
            <c:forEach items="${users}" var="user">
                <tr>
                    ...
                    <td><c:out value="${user.specialization}" /></td>
                     <td><a class='btnDelete' style='font-weight:bold' href="patientaddappointment.jsp?name=<c:out value="${user.firstName}" />&email=<c:out value="${user.email}" />">Make Appointment</a></td>
                   </tr>
            </c:forEach>
            </tbody>
            </tbody>
